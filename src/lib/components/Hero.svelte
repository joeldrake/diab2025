...
<section class="hero page-section">
	<div class="hero-inner page-section-inner">
		...
		>
			{#if theme === 'dark'}
				<svg
					...
					height="24"
					viewBox="0 0 24 24"
					class="hero__darkmode-toggle-light"
			...
			{:else}
				<svg
					...
					height="24"
					viewBox="0 0 24 24"
					class="hero__darkmode-toggle-dark"
					data-starting-styles="opacity:0"
				>
					<path
						fill="currentColor"
...
<style>
	...
	.hero__darkmode-toggle-dark {
		view-transition-name: toggle-dark;
	}

	.hero__darkmode-toggle-light {
		view-transition-name: toggle-light;
	}
	...
	::view-transition-old(toggle-dark) {
		animation: var(--animation-fade-out), var(--animation-slide-out-right);
	}

	::view-transition-new(toggle-dark) {
		opacity: 0;
		animation:
	...
	::view-transition-old(toggle-light) {
		animation: var(--animation-fade-out), var(--animation-slide-out-left);
	}

	::view-transition-new(toggle-light) {
		opacity: 0;
		animation:
			var(--animation-fade-in) forwards,
